  ...
  <v-app>
    ...
    >
      <div class="d-flex align-center flex-column flex-sm-row mt-16">
        ...
        <router-link
          v-if="!isUser"
          class="text-decoration-none ml-3 mt-3"
          :to="atLoginPath ? '/bulletin-board' : '/login'"
        >
    ...
    <v-main>
      <v-container v-if="showAddPost">
        <v-card
          color="transparent"
          class="item-card-1 elevation-0 pa-7 mx-auto my-16 my-sm-7"
          height="auto"
          width="400px"
        >
          <v-card-title class="justify-center pa-10"> Add a Post </v-card-title>
